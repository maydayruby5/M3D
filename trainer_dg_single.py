...
from PointDA.Models import PointNet,PointNetCLIP
...
parser.add_argument('--src_dataset', type=str, default='scannet', choices=['modelnet', '', 'scannet'])
parser.add_argument('--trgt_dataset', type=str, default='modelnet', choices=['shapenet', 'shapenet', 'scannet'])
parser.add_argument('--epochs', type=int, default=150, help='number of episode to train')
parser.add_argument('--model', type=str, default='pointnet', choices=['pointnet', 'dgcnn'], help='Model to use')
...
parser.add_argument('--batch_size', type=int, default=24, metavar='batch_size', help='Size of train batch per domain')
...
parser.add_argument('--DefRec_weight', type=float, default=0.1, help='weight of the DefRec loss')
