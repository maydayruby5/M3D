...
parser.add_argument('--DefRec_on_src', type=str2bool, default=True
                    , help='Using DefRec in source')
...
parser.add_argument('--test_batch_size', type=int, default=16, metavar='batch_size', help='Size of test batch per domain')
...
for epoch in range(args.epochs):
    ...
    for data1  in src_train_loader1:
        opt.zero_grad()
